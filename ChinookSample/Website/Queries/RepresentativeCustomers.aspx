...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <asp:Button ID="SubmitQuery" runat="server" Text="Fetch" /><br><br />
    ...
    <asp:ObjectDataSource ID="RepCustomerODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="RepresentitiveCustomers_Get" TypeName="ChinookSystem.BLL.CustomerController">
       <SelectParameters>
